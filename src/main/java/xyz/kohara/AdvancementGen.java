...
public class AdvancementGen {
  ...
  private static void createAdvancementFile(String name, AdvancementData.Advancement advancement,
      @Nullable String category) {
    Gson gson = new GsonBuilder().disableHtmlEscaping().setPrettyPrinting().create();

    String location = (category == null) ? ADVANCEMENT_FOLDER + "/" + name + ".json"
        : ADVANCEMENT_FOLDER + "/" + category + "/" + name + ".json";
  ...
  private static AdvancementData.Advancement rootAdvancement() {
    ...
    Map<String, Object> criteria = gson.fromJson(
        "{\"recipe\":{\"trigger\":\"minecraft:inventory_changed\",\"conditions\":{\"items\":[{\"predicates\":{\"minecraft:custom_data\":{\"stellarity:item\":\"endonomicon\"}}}]}}}",
        type);
